...
class _$LoginModelTearOff {
  ...
  _LoginModel call({String? message, String? token, String? refresh}) {
    return _LoginModel(
      message: message,
      token: token,
      refresh: refresh,
...
abstract class $LoginModelCopyWith<$Res> {
  ...
  $Res call({String? message, String? token, String? refresh});
}
...
class _$_LoginModel implements _LoginModel {
  const _$_LoginModel({this.message, this.token, this.refresh});
  ...
  @override
  String toString() {
    return 'LoginModel(message: $message, token: $token, refresh: $refresh)';
  }
...
abstract class _LoginModel implements LoginModel {
  const factory _LoginModel({String? message, String? token, String? refresh}) =
      _$_LoginModel;
